    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        */
        ...
        if ( count($errors) > 0 ) 
        {
            ...
            // Sauvegardons les données provenant du formulaire en session.
                ...
                <div class="col-md-8 col-lg-7 mx-auto p-4 shadow bg-white">
                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            <div class="col md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="first_name" id="edit_form_first_name" class="form-control" value="<?= isset($_SESSION['edit_form_old_values']['first_name']) ? $_SESSION['edit_form_old_values']['first_name'] : $contact['first_name'] ; unset($_SESSION['edit_form_old_values']['first_name']); ?>">
                                </div>
                            </div>
                            <div class="col md-6">
                                <div class="mb-3">
                                    <label for="edit_form_last_name">Nom</label>
                                    <input type="text" name="last_name" id="edit_form_last_name" class="form-control" value="<?= isset($_SESSION['edit_form_old_values']['last_name']) ? $_SESSION['edit_form_old_values']['last_name'] : $contact['last_name'] ; unset($_SESSION['edit_form_old_values']['last_name']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="edit_form_email" class="form-control" value="<?= isset($_SESSION['edit_form_old_values']['email']) ? $_SESSION['edit_form_old_values']['email'] : $contact['email'] ; unset($_SESSION['edit_form_old_values']['email']); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="edit_form_age">Age</label>
                                    <input type="number" name="age" id="edit_form_age" class="form-control" value="<?= isset($_SESSION['edit_form_old_values']['age']) ? $_SESSION['edit_form_old_values']['age'] : $contact['age'] ; unset($_SESSION['edit_form_old_values']['age']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone" id="edit_form_phone" class="form-control" value="<?= isset($_SESSION['edit_form_old_values']['phone']) ? $_SESSION['edit_form_old_values']['phone'] : $contact['phone'] ; unset($_SESSION['edit_form_old_values']['phone']); ?>">
                        </div>

                        <div class="mb-3">
                            <label for="edit_form_comment">Commentaires</label>
                            <textarea name="comment" id="edit_form_comment" class="form-control" rows="4"><?= isset($_SESSION['edit_form_old_values']['comment']) ? $_SESSION['edit_form_old_values']['comment'] : $contact['comment'] ; unset($_SESSION['edit_form_old_values']['comment']); ?></textarea>
                        </div>
